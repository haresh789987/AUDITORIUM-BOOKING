...
$sql = "SELECT 
            ...
            tblbooking.Status,
            tblbooking.ServiceID,  -- Added this line to select ServiceID
            tblservice.ServiceName  -- Added this line to select ServiceName
        FROM 
            tblbooking 
        JOIN 
            tbluser ON tbluser.ID = tblbooking.UserID 
        LEFT JOIN 
            tblservice ON tblservice.ID = tblbooking.ServiceID  -- Added this line for ServiceName
        WHERE 
            tblbooking.Status IS NULL";
