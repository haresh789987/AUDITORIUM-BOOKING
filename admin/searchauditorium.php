                            ...
                            <div class="block-content block-content-full">
                                ...
                                if (isset($_POST['search'])) {
                                    ...
                                    <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT tbluser.department, tbluser.ID, tbluser.FullName, tbluser.MobileNumber, tblbooking.BookingDate, tblbooking.Status, tblbooking.ID, tblservice.ID, tblservice.ServiceName
                                                    FROM tblbooking
                                                    JOIN tbluser ON tbluser.ID = tblbooking.UserID
                                                    LEFT JOIN tblservice ON tblservice.ID = tblbooking.ServiceID
                                                    WHERE 
                                                    tblservice.ServiceName = :selectedService AND MONTH(tblbooking.BookingDate) = :selectedMonth";
