                    ...
                    <div class="block">
                        ...
                        <div class="block-content block-content-full">
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                ...
                                <tbody>
                                    <?php
$sql = "SELECT tbluser.FullName, tbluser.MobileNumber, tbluser.department, tbluser.Email,
                tblbooking.ID as bid, tblbooking.BookingID, tblbooking.BookingDate, tblbooking.Status,
                tblbooking.ServiceID, tblservice.ServiceName
        FROM tblbooking
        JOIN tbluser ON tbluser.ID = tblbooking.UserID
        LEFT JOIN tblservice ON tblservice.ID = tblbooking.ServiceID
        WHERE  tblbooking.Status = 'Cancelled'";
...
<?php } else { ?>
    ...
    <?php
        ...
        $badgeClass = ($status === 'Approved') ? 'badge-success' : 'badge-danger';
    ?>
