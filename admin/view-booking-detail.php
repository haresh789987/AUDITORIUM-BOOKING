...
if (strlen($_SESSION['odmsaid']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        if (!empty($_GET['editid'])) { // Check if edit ID is not empty
            $eid = $_GET['editid'];
            ...
            echo "Edit ID is empty or not set.";
        }
    }
}
?>
