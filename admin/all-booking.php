                    ...
                    <div class="block">
                        ...
                        <div class="block-content block-content-full">
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                ...
                                <tbody>
                                    <?php
$sql = "SELECT tbluser.FullName, tbluser.MobileNumber, tbluser.department, tbluser.Email, tblbooking.ID as bid, tblbooking.BookingID, tblbooking.BookingDate, tblbooking.Status, tblbooking.ID,       tblbooking.ServiceID,   tblservice.ServiceName
        FROM tblbooking
